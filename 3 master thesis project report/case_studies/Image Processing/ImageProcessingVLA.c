...
static enum_Status_0 process_0(FileInputStream fis_7, FileOutputStream fos_5, State state_12) {
    int32_t norm_6 = 3;
    int32_t norm_7 = 1;
    int32_t leon_buffer_0[9] = { -2, -1, 0, -1, 1, 1, 0, 1, 2 };
    array_int32 norm_5 = (array_int32) { .data = leon_buffer_0, .length = 9 };
    ...
    if (tmp_4.tag == tag_Failure_0_Tuple_FileHeader_0_BitmapHeader_0) {
        ...
        if (!success_2) {
            norm_266 = tag_CorruptedDataError_0;
        } else if (tmp_4.value.Result_0_Tuple_FileHeader_0_BitmapHeader_0_v.result_0._2.width_0 == 0 || tmp_4.value.Result_0_Tuple_FileHeader_0_BitmapHeader_0_v.result_0._2.height_0 == 0) {
            norm_266 = tag_NoImageError_0;
        } else {
            int32_t surface_0 = tmp_4.value.Result_0_Tuple_FileHeader_0_BitmapHeader_0_v.result_0._2.width_0 * tmp_4.value.Result_0_Tuple_FileHeader_0_BitmapHeader_0_v.result_0._2.height_0;
            int32_t leon_length_0 = surface_0;
            int8_t leon_buffer_1[leon_length_0];
            int32_t leon_i_0;
            for (leon_i_0 = 0; leon_i_0 < leon_length_0; ++leon_i_0) {
                leon_buffer_1[leon_i_0] = 0;
            };
            array_int8 norm_115 = (array_int8) { .data = leon_buffer_1, .length = leon_length_0 };
            array_int8* norm_118 = &norm_115;
            int32_t leon_length_1 = surface_0;
            int8_t leon_buffer_2[leon_length_1];
            int32_t leon_i_1;
            for (leon_i_1 = 0; leon_i_1 < leon_length_1; ++leon_i_1) {
                leon_buffer_2[leon_i_1] = 0;
            };
            array_int8 norm_116 = (array_int8) { .data = leon_buffer_2, .length = leon_length_1 };
            array_int8* norm_119 = &norm_116;
            int32_t leon_length_2 = surface_0;
            int8_t leon_buffer_3[leon_length_2];
            int32_t leon_i_2;
            for (leon_i_2 = 0; leon_i_2 < leon_length_2; ++leon_i_2) {
                leon_buffer_3[leon_i_2] = 0;
            };
            array_int8 norm_117 = (array_int8) { .data = leon_buffer_3, .length = leon_length_2 };
...
static enum_Status_0 processImage_0(FileInputStream* fis_7, FileOutputStream* fos_5, State* state_12, Kernel_0* kernel_1, Image_0* src_2) {
    ...
    int32_t surface_0 = src_2->w_0 * src_2->h_0;
    int32_t leon_length_3 = surface_0;
    int8_t leon_buffer_4[leon_length_3];
    int32_t leon_i_3;
    for (leon_i_3 = 0; leon_i_3 < leon_length_3; ++leon_i_3) {
        leon_buffer_4[leon_i_3] = 0;
    };
    array_int8 norm_145 = (array_int8) { .data = leon_buffer_4, .length = leon_length_3 };
    array_int8* norm_148 = &norm_145;
    int32_t leon_length_4 = surface_0;
    int8_t leon_buffer_5[leon_length_4];
    int32_t leon_i_4;
    for (leon_i_4 = 0; leon_i_4 < leon_length_4; ++leon_i_4) {
        leon_buffer_5[leon_i_4] = 0;
    };
    array_int8 norm_146 = (array_int8) { .data = leon_buffer_5, .length = leon_length_4 };
    array_int8* norm_149 = &norm_146;
    int32_t leon_length_5 = surface_0;
    int8_t leon_buffer_6[leon_length_5];
    int32_t leon_i_5;
    for (leon_i_5 = 0; leon_i_5 < leon_length_5; ++leon_i_5) {
        leon_buffer_6[leon_i_5] = 0;
    };
    array_int8 norm_147 = (array_int8) { .data = leon_buffer_6, .length = leon_length_5 };
...
static int32_t statusCode_0(enum_Status_0 s_0) {
    if (s_0 == tag_Success_0) {
        ...
        return 7;
    } else if (s_0 == tag_NoImageError_0) {
        println_0("the image is empty");
        return 8;
