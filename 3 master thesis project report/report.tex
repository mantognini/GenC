...
pattern matching, Leon detect potential misuse of the language that can result
...
well as from signed to unsigned are consistent:
\begin{ShortCode}{Leon}
...
and the kernel matrix, which represent the weight of each pixels in the vicinity
...
add some constraint on the kernel size and its matrix content. For example, if
